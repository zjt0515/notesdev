...
汇编语言实现一个可以在显示器上**显示时、分、秒**的电子时钟，并能提供**整点报时**功能。

1. 设计一个基本的具有显示时、分、秒的电子时钟。
2. 到**整点或预定的报警时间**，能够以**不同的音乐**进行报时，可以自行设置闹钟报警时间； 
3. 实物演示时要求讲出程序原理和设计思想；

1. https://github.com/fengdang1/ElectronicClock
2. https://github.com/urnotLimited/Digital-Clock
...
1. https://github.com/rhythms06/cs416
2. https://github.com/Mysterious-2/os-id1206-labs/blob/main/Lab3/src/address_translation.c
